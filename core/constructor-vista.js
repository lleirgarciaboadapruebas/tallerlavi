...
var constructorDeVistas = {
    ...
    setEncabezado:
        function(vista, modulo) {
            ...
            if(vista == "list"){
                if(modulo == "cliente")
                    $(".div-buttons-encabezado").append("<button class='button tiny radius' style='margin: 5px;'onclick='actionViewCrearCliente()'>Crear " + modulo + "&nbsp;&nbsp;<img src='./resources/crear" + modulo + ".png'></button></div>");
                if(modulo == "factura")
                    $(".div-buttons-encabezado").append("<button class='button tiny radius' style='margin: 5px;'onclick='actionViewCrearFactura()'>Crear " + modulo + "&nbsp;&nbsp;<img src='./resources/crear" + modulo + ".png'></button></div>");
                if(modulo == "vehiculo")
                    $(".div-buttons-encabezado").append("<button class='button tiny radius' style='margin: 5px;'onclick='actionViewCrearVehiculo()'>Crear " + modulo + "&nbsp;&nbsp;<img src='./resources/" + modulo + ".png'></button></div>");
            }
    ...
    vistaCrearCliente: function(request){
        ...
        $(".contenido-modulo-inferior").append("<div class='viewForm form-group div-buttons-modulo'>" +
            "<button type='button' class='button success tiny radius' onclick='actionCreateCliente(form_create_cliente)'>Crear cliente</button>" +
            "<button type='button' class='button alert tiny radius button-cancel' onclick='actionVerListadoClientes()'>Cancelar</button>");
    ...
    vistaCrearVehiculo: function(request){
        ...
        $(".contenido-modulo-inferior").append("<div class='viewForm form-group div-buttons-modulo'>" +
            "<button type='button' class='button success tiny radius' onclick='actionCrearVehiculo(form_create_vehiculo)'>Crear vehiculo</button>" +
            "<button type='button' class='button alert tiny radius button-cancel' onclick='actionVerListadoVehiculos()'>Cancelar</button>");
        $(".contenido-modulo-inferior").append("<div id='validation' class='viewForm form-group validation-error'></div>");
    ...
    vistaCrearFactura: function(request, codigo) {
        ...
        $(".contenido-modulo-inferior").append("<div class='viewForm form-group'><label class='label-obligatorio label-result label-precio_hora'>Precio hora: *</label><input style='margin-left: -82px;' id='entity_precio_hora' value='36' class='IO input-result inputForm form-control'>");
        ...
        $(".contenido-modulo-inferior").append("<div class='viewForm form-group div-buttons-modulo'>" +
            "<button type='button' class='button success tiny radius' onclick='actionCrearFactura(form_create_factura)'>Guardar datos</button>" +
            "<button type='button' class='button alert tiny radius button-cancel' onclick='actionVerListadoFacturas()'>Cancelar</button>");
        $(".contenido-modulo-inferior").append("<div id='validation' class='viewForm form-group validation-error'></div>");
    ...
    vistaConceptosCrear: function (requestConceptos, requestFactura){
        ...
        $("#anadeConceptos").append("<table id='table-conceptos' class='table-conceptos'><tbody><td>Tipo</td><td>Concepto</td><td>Cantidad</td><td>Precio</td><td>Acciones</td></td></tr></tbody>");
    ...
    vistaConceptosEdit: function(request, requestFactura){
        ...
        $("#anadeConceptos").append("<table id='table-conceptos' class='table-conceptos'><tbody><td>Tipo</td><td>Concepto</td><td>Cantidad/Hora</td><td>Precio</td><td>Acciones</td></td></tr></tbody>");
            ...
            if(request.manoobra != null) {
                for (var mano = 0; mano < request.manoobra.length; mano++) {
                    ...
                    $("#" + id).append("<td style='width: 5%;'><input class='concept' id='entity.tipo_" + row + "' name='tipo' type='text' readonly maxlength='1' maxlength='62' value='" + request.manoobra[mano].tipo + "' ></td>" +
                        "<td style='width: 40%;'><input class='concept'id='entity.concepto_" + row + "' name='concepto' type='text' readonly maxlength='48' value='" + request.manoobra[mano].detalle + "' ></td>" +
            ...
            if(request.recambios != null) {
                for (var re = 0; re < request.recambios.length; re++) {
                    ...
                    $("#" + id).append("<td style='width: 5%;'><input class='concept' id='entity.tipo_" + row + "' name='tipo' type='text' readonly maxlength='10' maxlength='62' value='" + request.recambios[re].tipo + "' ></td>" +
                        "<td style='width: 40%;'><input class='concept' id='entity.concepto_" + row + "' name='concepto' type='text' readonly maxlength='48' value='" + request.recambios[re].detalle + "' ></td>" +
    ...
    vistaEditarCliente: function(request){
        ...
        $(".contenido-modulo-inferior").append("<div class='viewForm form-group div-buttons-modulo'>" +
            "<button type='button' class='button success tiny radius' onclick='actionUpdateCliente(" + request[0].id + ", \"" + request[0].nif + "\", form_update_cliente)'>Guardar datos</button>" +
            "<button type='button' class='button alert tiny radius button-cancel' onclick='actionVerCliente(" + request[0].id + ")'>Cancelar</button>");
        $(".contenido-modulo-inferior").append("<div id='validation' class='viewForm form-group validation-error'></div>");
    ...
    vistaEditarVehiculo: function(request){
        ...
        $(".contenido-modulo-inferior").append("<div class='viewForm form-group div-buttons-modulo'>" +
            "<button type='button' class='button success tiny radius' onclick='actionUpdateVehiculo(" + request[0].id + ", \"" + request[0].matricula + "\", form_update_vehiculo)'>Guardar datos</button>" +
            "<button type='button' class='button alert tiny radius button-cancel' onclick='actionVerVehiculo(" + request[0].id + ")'>Cancelar</button>");
        $(".contenido-modulo-inferior").append("<div id='validation' class='viewForm form-group validation-error'></div>");
    ...
    vistaEditarFactura: function(requestFactura, requestConceptos){
        ...
        $(".contenido-modulo-inferior").append("<div class='viewForm form-group'><label class='label-obligatorio label-result label-precio_hora'>Precio hora: *</label><input value='" + requestFactura[0].precio_hora + "' style='margin-left: -82px;' id='entity_precio_hora' class='IO input-result inputForm form-control'>");
        $(".contenido-modulo-inferior").append("<div class='viewFormTitle box effect1'><span class='titleViewForm'>Vehiculo</span> </div>");
        ...
        $(".contenido-modulo-inferior").append("<div class='viewForm form-group div-buttons-modulo'>" +
            "<button type='button' class='button success tiny radius' id='button-guardar' onclick='actionUpdateFactura(\"" + requestFactura[0].id + "\", \"" + requestFactura[0].codigo + "\", form_update_factura)'>Guardar datos</button>" +
            "<button type='button' class='button alert tiny radius button-cancel' onclick='actionVerListadoFacturas()'>Cancelar</button>");
        $(".contenido-modulo-inferior").append("<div id='validation' class='viewForm form-group validation-error'></div>");
    ...
    vistaVerCliente: function(request){
        ...
        $(".contenido-modulo-inferior").append("<div class='viewForm form-group div-buttons-modulo'>" +
            "<button type='button' class='button tiny radius' onclick='actionVerDetalleCliente(" + request[0].id + ")'>Modificar datos</button>");
        $(".contenido-modulo-inferior").append("<div id='validation' class='viewForm form-group validation-error'></div>");
    ...
    vistaVerCoche: function(request){
        ...
        $(".contenido-modulo-inferior").append("<div class='viewForm form-group div-buttons-modulo'>" +
            "<button type='button' class='button tiny radius' onclick='actionVerDetalleVehiculo(" + request[0].id + ")'>Modificar datos</button>");
        $(".contenido-modulo-inferior").append("<div id='validation' class='viewForm form-group validation-error'></div>");
    ...
    vistaVerFactura: function(requestFactura, requestConceptos){
        ...
        $(".contenido-modulo-inferior").append("<div class='viewForm form-group div-buttons-modulo'>" +
            "<button type='button' class='button tiny radius' onclick='actionVerDetalleFactura(\"" + requestFactura[0].codigo + "\")'>Modificar datos</button>");
        $(".contenido-modulo-inferior").append("<div id='validation' class='viewForm form-group validation-error'></div>");
